  ...
  return (
    ...
    {items.map(function(item, index){
                ...
                <div class="content-component">
                    ...
                    <p class="text-center color-text"><b class="b-text text-white">{item.from}</b> paid <b class="b-text text-white">{item.to}</b></p>
                ...
                <div class="content-impact" >
                    ...
                    <a href={`/flow?id=${item.transactionId}`}  class="btn-small">Analyse Impact</a>
                </div>
