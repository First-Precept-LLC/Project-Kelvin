...
export class convoConnector extends React.Component {
  ...
  <nav class="navbar navbar-light bg-light flow" >
    ...
    <ul class="nav nav-pills nav-fill mt-2 mx-2 ">
        <li class="nav-item">
            <a class="nav-link active color-bg" aria-current="page" href="/add-impact">Add Impact Flow</a>
        </li>
        <li class="nav-item">
    ...
    <div class="container flow-container" >
        <div class="d-flex justify-content-center flex-column mt-5 options-list">
            <a href="/add-impact-type"  class="options-item">Carbon Impact Analysis</a>
            <a href="#" class="options-item">Political Lobbying Analysis</a>
            <a href="#" class="options-item">AGI Capabilities Analysis</a>
        </div>
