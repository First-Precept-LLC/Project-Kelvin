...
export class calculate extends React.Component {
 ...
 state = {
  ...
  addFormFields() {
    this.setState(({
      calcValues: [...this.state.calcValues, { name: "", variable1 : "",operation:"",variable2 : ""  }]
    }))
  }
  ...
  handleSubmit(event) {
    ...
    for(var i=0;i<this.state.calcValues.length;i++){
        ...
        if(obj)
        variables[variables.length] =obj;
...
<Header />
        ...
        <div class="row">
            <div class="col">
                <nav class="nav nav-pills nav-justified">
                    <a class="nav-link active" aria-current="page" href="#">Impact Flow</a>
                    <a class="nav-link" href="/convo">Impact Discussion</a>
                </nav>
            </div>
        </div>
    </section>
    <section class="container text-center ">
          ...
          <div class="row">
            <div class="col my-block m-2 px-4 flex-column align-items-start">
                <div class="d-flex align-items-center flex-row justify-content-between w-100 mb-2">
                    <h6>Name</h6>
                    <p><input  name="name" onChange={e => this.handleChange(index, e)}  type="text" placeholder="Variable Name" /></p>
                </div>
      ...
      /></p>
            ...
            <button class="btn btn-primary btn-color" onClick={() => this.removeFormFields(index)}  type="button"> Remove</button>
        ...
        <div class="d-grid gap-2 mt-4">
          <button onClick={() => this.addFormFields()} type="button" class="btn btn-primary btn-color" data-bs-toggle="modal" data-bs-target="#exampleModal">
                Add
              </button>
            <button class="btn btn-primary btn-color" onClick={() => this.handleSubmit()} type="submit"> Next</button>
        </div>
    </section>
