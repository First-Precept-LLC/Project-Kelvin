 ...
 state = {
  ...
  handleCapitalOperationChange = async(selectedCapitalOptionOperation) => {
    ...
    caluclateTime = async () => {
      ...
      if(this.state.selectedTimeOptionV1 && this.state.selectedTimeOptionV2 && this.state.selectedTimeOptionOperation ){
  ...
  'Access-Control-Allow-Origin': '*'
    ...
    caluclateCapital = async () => {
      ...
      if(this.state.selectedCapitalOptionV1 && this.state.selectedCapitalOptionV2 && this.state.selectedCapitalOptionOperation ){
...
<Header />
   ...
   <section class="container text-center ">
      ...
      /></p>
                ...
                <div class="d-flex justify-content-between w-100 mb-2 align-items-center  flex-row border-bottom pb-2">
                    <h6>Variable 2</h6>
                    <p> <Select
                    name="variable2"
      ...
      /></p>
        ...
        <div class="d-grid gap-2 mt-4">
            ...
            <button class="btn btn-primary btn-color" type="button"> Done</button>
        </div>
    </section>
